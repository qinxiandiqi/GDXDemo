...
public class ReflectionCorrectnessTest extends GdxTest {
	...
	public void testCustomInterfaceClass () {
		Class clazz = com.qinxiandiqi.gdxdemo.office.ReflectionCorrectnessTest.AbstractInterfaceStatic.class;
	...
	public void testCustomInterfaceArrayClass () {
		Class clazz = com.qinxiandiqi.gdxdemo.office.ReflectionCorrectnessTest.AbstractInterfaceStatic[].class;
		Class componentClazz = com.qinxiandiqi.gdxdemo.office.ReflectionCorrectnessTest.AbstractInterfaceStatic.class;
		Expectation e = new Expectation().mArray().mCompType(componentClazz);
		doTest(clazz, e);
	}

	public void testCustomAnnotationClass () {
		Class clazz = com.qinxiandiqi.gdxdemo.office.ReflectionCorrectnessTest.AbstractAnnotationStatic.class;
	...
	public void testCustomAnnotationArrayClass () {
		Class clazz = com.qinxiandiqi.gdxdemo.office.ReflectionCorrectnessTest.AbstractAnnotationStatic[].class;
		Class componentClazz = com.qinxiandiqi.gdxdemo.office.ReflectionCorrectnessTest.AbstractAnnotationStatic.class;
		Expectation e = new Expectation().mArray().mCompType(componentClazz);
		doTest(clazz, e);
	}

	public void testCustomEnumClass () {
		Class clazz = com.qinxiandiqi.gdxdemo.office.ReflectionCorrectnessTest.StaticEnum.class;
	...
	public void testCustomEnumArrayClass () {
		Class clazz = com.qinxiandiqi.gdxdemo.office.ReflectionCorrectnessTest.StaticEnum[].class;
		Class componentClazz = com.qinxiandiqi.gdxdemo.office.ReflectionCorrectnessTest.StaticEnum.class;
		Expectation e = new Expectation().mArray().mCompType(componentClazz);
		doTest(clazz, e);
	}
